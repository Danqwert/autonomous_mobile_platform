...
### Аппаратная часть
- Raspberry Pi 4 - главный компьютер, взаимодействует с датчиками (камера Kinect, лидар YDlidar X2L) и их контроллерами, а также обеспечивает удаленный доступ.
...
### Программная часть
- ROS Noetic установленный на Raspberry pi OS, 
