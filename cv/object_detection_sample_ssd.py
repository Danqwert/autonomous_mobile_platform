...
def parse_args() -> argparse.Namespace:
    ...
    args.add_argument('-m', '--model', default='/home/pi/Desktop/project/model_mk1.xml', type=str,
...
def main():  # noqa
    ...
    original_image=np.load('/home/pi/Desktop/project/image.npy')
    pil_img=Image.fromarray(original_image)
    pil_img.save('/home/pi/Desktop/project/img.jpg')
    #original_image=cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB)
    original_image = cv2.imread('/home/pi/Desktop/project/img.jpg')
    original_image=original_image[160:480, 0:640]
